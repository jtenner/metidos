...
- Optimization slices must stay measurement-led. `OPT01.*` should establish the baseline before speculative follow-on slices are pulled forward.
...
- [OPT01.1] Runtime stats collector - Add cheap per-RPC timing, payload, retry, and cache counters so later optimization work is driven by measured hotspots.
  Reference: [docs/2026-04-11-optimization-execution-proposal.md](./docs/2026-04-11-optimization-execution-proposal.md), `OPT01` / `OPT01.1`; [docs/optimization-proposals.md](./docs/optimization-proposals.md) §§6.2, 7.2, 3.2.
