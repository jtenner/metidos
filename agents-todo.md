...
- None tracked in the backlog. Unsupported keyring behavior is already called out where operators need it in the README/settings docs. Provider mix-ups are user error: Skill Issue.

## Blockers

- None for the supported Pi-native path.
