...
- [ ] Add a plugin permission reference/schema drift guard. Context: `docs/plugin-permission-test-gap-audit-2026-06-02.md` recommends a small contract test that every permission documented in `docs/plugin-permissions.md` appears in the manifest permission enum, and every enum value has a public reference entry.
