...
const procedures: ProjectProcedures = {
  ...
  searchMemoryFacts: createProcedure("searchMemoryFacts"),
  getMemoryFactDetail: createProcedure("getMemoryFactDetail"),
  getMemoryEvidenceDetail: createProcedure("getMemoryEvidenceDetail"),
  listMemoryEvidence: createProcedure("listMemoryEvidence"),
  listMemoryRecallEvents: createProcedure("listMemoryRecallEvents"),
  listMemoryWriteEvents: createProcedure("listMemoryWriteEvents"),
  getMemoryStats: createProcedure("getMemoryStats"),
  eraseMemory: createProcedure("eraseMemory"),
