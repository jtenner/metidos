...
Source images observed include `bird.png`, `docs/uploadthing-test.png`, and `src/mainview/pixel-crown.png`; `src/mainview/crown.png` and `src/mainview/logo.png` were removed on 2026-06-02 because they were unused and lacked public-redistribution provenance. The remaining assets need the separate asset ownership/provenance review already listed in `agent-todo.md`.
