...
- `src/mainview/crown.png` and `src/mainview/logo.png` were inspected beyond the base inventory on 2026-06-02; no textual metadata or useful Git history was found for either asset, so their public-readiness decisions remain blocked on maintainer confirmation.
