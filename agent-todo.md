...
- [ ] Add OAuth provider permission regression tests. Context: `docs/plugin-permission-test-gap-audit-2026-06-02.md` found positive OAuth provider coverage but missing negative checks; add tests proving manifest/startup/runtime OAuth provider registration fails without `oauth:register` and reports deterministic permission errors.
- [ ] Add prompt injection permission regression tests. Context: `docs/plugin-permission-test-gap-audit-2026-06-02.md` found positive prompt injection coverage but missing negative checks; add tests proving declarations/startup/runtime prompt injection registration fails without `metidos:prompt_inject` and reports deterministic permission errors.
...
- [ ] Add cron procedure input and capacity validation tests. Context: `docs/cron-test-gap-audit-2026-06-02.md` found missing coverage for blank/missing schedule, prompt, title, and description inputs in `newCronProcedure`/`updateCronProcedure`, max-length errors, `MAX_CRON_JOBS`, `MAX_ACTIVE_CRON_JOBS`, and expanded-handle limits.
