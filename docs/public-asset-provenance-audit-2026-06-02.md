...
- `src/mainview/crown.png` was inspected beyond the base inventory on 2026-06-02; no textual metadata or useful Git history was found, so its public-readiness decision remains blocked on maintainer confirmation.
