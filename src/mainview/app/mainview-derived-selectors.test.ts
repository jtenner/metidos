...
describe("mainview derived selectors", () => {
  ...
  it("builds shared worktree lookups, display paths, and search text in one pass", () => {
    const projects = [project(7, "/Users/example/project")];
    ...
    expect(result.projectSearchTextById.get(7)).toContain("~/project");
    expect(
      result.worktreeSearchTextByKey.get(
        worktreeKey(7, "/Users/example/project/feature"),
      ),
    ).toContain("~/project/feature");
  });
