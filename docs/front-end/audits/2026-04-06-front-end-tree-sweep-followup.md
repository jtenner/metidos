...
- Added a source-backed research note for page header orientation and breadcrumbs.
...
- Narrowed the hierarchy note further by separating page-header orientation and breadcrumb conventions into their own research note.
...
- Page-header composition now lives in a separate research note instead of being implied by the hierarchy note.
